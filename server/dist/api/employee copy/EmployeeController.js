...
const newEmployee = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const newEmployeeData = yield (0, EmployeeService_1.createEmployee)(name, email, isHRAdmin, shiftId, positionId);
        res.send({
            status: 'success',
...
const editEmployeeInfo = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const newEmployeeData = yield (0, EmployeeService_1.updateEmployee)(id, name, email, isHRAdmin, shiftId, positionId);
        res.send({
            status: 'success',
