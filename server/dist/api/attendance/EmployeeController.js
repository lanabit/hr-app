...
const showEmployees = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const employees = yield findEmployees();
        res.send({
            status: 'success',
            data: employees
        });
...
const newEmployee = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const newEmployeeData = yield createEmployee(name, email, isHRAdmin, shiftId, positionId);
        res.send({
            status: 'success',
...
const editEmployeeInfo = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const newEmployeeData = yield updateEmployee(id, name, email, isHRAdmin, shiftId, positionId);
        res.send({
            status: 'success',
